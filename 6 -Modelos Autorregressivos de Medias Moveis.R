...
View(Inflacao)
autoplot(Inflacao, main="Índie de Preços ao Consumidor Amplo")      #Novo comando de criar gráfico, inerente ao pacote ggplo2
Resumo_Estatístico <- summary(Inflacao)
Resumo_Estatístico

acf(IPCA)                                 #Sugere autocorrelação com os erros de até nível 3
...
ARMA13 <- arima(Inflacao,order = c(1,0,3))       #É a soma de AR1 com MA3
ARMA13
